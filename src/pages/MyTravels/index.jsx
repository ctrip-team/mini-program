        ...
        <ScrollView className="Travals_scrollView">
          {
            listData && listData.map((item, index) => (
              <TravalListItem props={{ id: item.travel_id, poster: item.poster_url, imgsrc: item.image_url, title: item.title, content: item.content, status: item.status, videosrc: item.video_url, reason: item.reason }} />
            ))
          }
          {
